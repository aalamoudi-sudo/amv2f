...
const stagingParent = mkdtempSync(path.join(os.tmpdir(), 'mayadeen-stage3g1b-review-'));
...
try {
  ...
  const documentation = [
    'docs/stage-3g1b-authority-contract-integrity-closure.md',
  ...
  const manifest = {
    stage: '3G.1B',
    status: 'READY_FOR_FOUNDER_STAGE_3G1B_REVIEW',
    ...
    sourceFingerprint: '9bc85024e3d1d8707518582607d1200560e4d64d0d5ef4902f01d971c6301f97',
    sourceTraceFingerprint: '900cd8a205b170e4893fb2a938a98628925a504dfb13b20ee045131b3f7d5530',
  ...
  writeFileSync(path.join(stagedRoot, 'README.md'), [
    '# Mayadeen Stage 3G.1B Founder Review',
    '',
    'This archive reviews the event-agnostic derived authority contract and its fail-closed behavior.',
    '',
    ...
    '',
    'Raw PPTX, XLSX, DWG, private contact data, GPS, credentials, and secrets are excluded.',
    ''
  ].join('\n'));
