function normalizeForHash(value: unknown): unknown {
  ...
  if (value && typeof value === 'object') {
    return Object.entries(value)
      ...
      .reduce<Record<string, unknown>>((record, [key, candidate]) => {
        if (candidate !== undefined) record[key] = normalizeForHash(candidate);
        return record;
      }, {});
  }
...
export async function sha256Payload(value: unknown): Promise<string> {
...
export function sha256PayloadSync(value: unknown): string {
